  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Columna visual — video real de la app ── */}
        <Box
          sx={{
            flex: 1,
            width: "100%",
          ...
          <Box sx={{ position: "relative" }}>
            ...
            >
              <Stack direction="row" spacing={1} alignItems="center" mb={0.5}>
                ...
                <Typography
                  sx={{ fontSize: 11, fontWeight: 800, color: C.ink }}
                >
                  {isUS ? "Auto-added up" : "Suma automática"}
                </Typography>
              </Stack>
              <Typography
                sx={{ fontSize: 12, color: C.muted, lineHeight: 1.4 }}
              >
        ...
        >
          ...
          >
            <Box sx={{ flexShrink: 0 }}>
              ...
              <Typography
                sx={{ fontSize: 13, color: "rgba(255,255,255,0.40)" }}
              >
                {isUS
      ...
      <Stack spacing={1.1} mb={3.5}>
        {p.features.map((f) => (
          <Stack key={f} direction="row" spacing={1.2} alignItems="flex-start">
            ...
            <Typography
              sx={{ fontSize: 13, color: C.textSec, lineHeight: 1.5 }}
            >
              {f}
            </Typography>
          </Stack>
  ...
  const fetchPage = async (p, isFirst = false) => {
    ...
    try {
      const res = await fetch(
        `${API_URL}/api/posts/${notesLang}/landing?page=${p}`,
      );
    ...
    >
      <Box sx={{ maxWidth: 900, mx: "auto" }}>
        ...
        <Box mb={5}>
          ...
          >
            {isUS
              ? "Health, nutrition & wellness — today"
      ...
      <Box sx={{ maxWidth: 1100, mx: "auto" }}>
        ...
        {!isUS && (
          ...
          >
            ...
            >
              <GppGoodRoundedIcon sx={{ fontSize: 13 }} /> Defensa del
              Consumidor
            </Box>
            <Typography
              sx={{
        ...
        >
          {isUS ? (
            ...
            <>
              Nui es una aplicación de salud y nutrición. No reemplaza el
...
const LandingPage = () => {
  ...
  usePageMeta(
    isUS
      ? {
          title:
            "Nui — Your AI Health Assistant | Nutrition, Recipes & Training",
          description:
            "Nui is your AI health assistant. Scan food labels for instant analysis, generate personalized healthy recipes, get a training plan and track your daily energy balance by voice. Free for 7 days.",
          ogTitle: "Nui — Your AI Health Assistant",
          ogDescription:
            "Analyze food, generate healthy recipes, train with AI and track your daily calorie balance by voice. All in one app. Free 7 days.",
          canonical: "/en",
          alternates: [
            { hreflang: "es-AR", href: "/" },
            { hreflang: "en", href: "/en" },
      ...
      : {
          title:
            "Nui — Tu asistente de salud con IA | Nutrición, Recetas y Entrenamiento",
          description:
            "Nui es tu asistente de salud con IA. Analizá alimentos escaneando etiquetas, generá recetas saludables personalizadas, entrenamiento y seguí tu balance energético diario por voz. Gratis por 7 días.",
          ogTitle: "Nui — Tu asistente de salud con IA",
          ogDescription:
            "Analizá alimentos, generá recetas saludables, entrená con IA y controlá tu balance calórico diario por voz. Todo en una sola app. Gratis 7 días.",
          canonical: "/",
          alternates: [
            { hreflang: "es-AR", href: "/" },
            { hreflang: "en", href: "/en" },
